#' Add a custom set of precomputed trees for a patient.
#'
#' @description 
#' 
#' TODO
...
#' @param trees A list a of precomputed adjacency matrix to describe the custom trees.
#' @param scores A list a of precomputed scores to describe the custom trees.
#'
